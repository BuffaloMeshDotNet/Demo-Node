...
cat << _EOF
This script preps a Debian-based machine to host some demo applications for a 
mesh node. It should work on any Debian based distro, but tested against the
current Debian and Ubuntu distros.
...
clobber your web content.  You can
...
echo "Chat..."
git clone https://github.com/BuffaloMeshDotNet/webchat.git
touch /var/www/html/webchat/msg.html
chmod ugo+rw /var/www/html/webchat/msg.html
echo "Library..."
git clone https://github.com/BuffaloMeshDotNet/library.git
